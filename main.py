...
async def balance(interaction: discord.Interaction, user : discord.Member = None):
    if user == None:
        user = interaction.user.id
@@ -53,17 +51,16 @@ async def balance(interaction: discord.Interaction, user : discord.Member = None
        for user_info in user_info:
            valid = True
        if not valid:
...
@@ -74,137 +71,180 @@ async def balance(interaction: discord.Interaction, user : discord.Member = None
            valid = True
        if valid == True:
            balance = user_info['balance']
